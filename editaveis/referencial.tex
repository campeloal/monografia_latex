...
\label{teoria}
	...
	Como os vetores \overrightarrow{lightDir} e \overrightarrow{normal} são normalizados, o cálculo pode ser simplificado de acordo com a Equação \ref{eqtoons}.
